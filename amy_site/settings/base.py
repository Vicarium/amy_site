# flake8: noqa
"""
Django settings for amy_site project.
...
DJANGO_ROOT = root.path('amy_site')
...
WSGI_APPLICATION = 'amy_site.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///amy_site'),
}
